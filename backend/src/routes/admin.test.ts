...
describe('Admin API Routes', () => {
  ...
  describe('GET /api/admin/export', () => {
    ...
    it('should export game state correctly', async () => {
      ...
      const gameEnabled = body.gameState.find((s: any) => s.key === 'game_enabled');
  ...
  describe('POST /api/admin/import', () => {
    it('should import database when authenticated as host', async () => {
      const importData = {
        ...
        gameState: [{ key: 'game_enabled', value: 'false', updatedAt: '2025-01-01 00:00:00' }],
      };
    ...
    it('should replace existing players on import', async () => {
      ...
      const importData = {
        ...
        gameState: [{ key: 'game_enabled', value: 'true', updatedAt: '2025-01-01 00:00:00' }],
      };
  ...
  describe('Round-Trip (Export → Import)', () => {
    it('should preserve data through API export/import cycle', async () => {
      ...
      expect(exportedData.gameState.find((s: any) => s.key === 'game_enabled')?.value).toBe(
        'false',
      );
      ...
      expect(players).toHaveLength(3);
      expect(players.some((p: any) => p.first_name === 'Alice')).toBe(true);
