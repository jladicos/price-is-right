 ...
 *
 * Post-Import Effects:
 * - Session tokens PRESERVED for existing players (users stay logged in)
...
export function ImportDatabaseModal({
  ...
  return (
    <DialogRoot
      open={isOpen}
      onOpenChange={(e) => !e.open && handleModalClose()}
      size="md"
    >
      <DialogContent>
        ...
        <DialogBody>
          <VStack gap="4" align="stretch">
            <Alert
              status="warning"
              title="WARNING: This will delete all existing data!"
            >
              The current database will be completely replaced with the imported
              data. Your session will be preserved.
            </Alert>
