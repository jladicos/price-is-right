...
describe('PlayerCard', () => {
  ...
  describe('Badge Display', () => {
    ...
    it('should use custom badgeTestId when provided', () => {
      render(<PlayerCard player={mockPlayer} badge="WINNER" badgeTestId="custom-badge-id" />);
  ...
  describe('Combined Props', () => {
    ...
    it('should render eliminated variant with badge', () => {
      render(<PlayerCard player={mockPlayer} variant="eliminated" badge="ELIMINATED" />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long player names', () => {
      ...
      expect(screen.getByAltText('Christopher Worthington-Smythe')).toBeInTheDocument();
    });
