...
describe("WheelDisplay", () => {
  ...
  describe("Segment Display", () => {
    ...
    it("should display segments in correct order", () => {
      ...
      const expectedOrder = [
        15, 80, 35, 60, 20, 40, 75, 55, 95, 50, 85, 30, 65, 10, 45, 70, 25, 90,
        5, 100,
      ];
  ...
  describe("Interaction", () => {
    ...
    it("should not call onSpin when disabled", async () => {
      ...
      render(
        <WheelDisplay currentValue={100} onSpin={onSpin} disabled={true} />,
      );
    ...
    it("should not call onSpin when spinning", async () => {
      ...
      render(
        <WheelDisplay currentValue={100} onSpin={onSpin} isSpinning={true} />,
      );
  ...
  describe("Button States", () => {
    ...
    it("should enable button when not disabled and not spinning", () => {
      render(
        <WheelDisplay currentValue={100} disabled={false} isSpinning={false} />,
      );
  ...
  describe("Animation", () => {
    ...
    it("should apply transition when spinning", () => {
      render(
        <WheelDisplay currentValue={100} targetValue={50} isSpinning={true} />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle spinning with same start and target value", () => {
      render(
        <WheelDisplay currentValue={50} targetValue={50} isSpinning={true} />,
      );
    ...
    it("should handle very large targetValue", () => {
      render(
        <WheelDisplay currentValue={5} targetValue={100} isSpinning={true} />,
      );
    ...
    it("should handle rapid state changes", () => {
      const { rerender } = render(
        <WheelDisplay currentValue={5} isSpinning={false} />,
      );
    ...
    it("should handle disabled state with onSpin callback", async () => {
      const onSpin = vi.fn();
      render(
        <WheelDisplay currentValue={50} onSpin={onSpin} disabled={true} />,
      );
