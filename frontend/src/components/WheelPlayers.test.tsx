...
describe('WheelPlayers', () => {
  describe('Basic Rendering', () => {
    it('should render container when sections exist', () => {
      testRender(<WheelPlayers currentSpinner={mockContestant1} currentTotal={0.5} />);
    ...
    it('should return null when leader is null and no other sections', () => {
      const { container } = testRender(<WheelPlayers leader={null} leaderTotal={0} />);
  ...
  describe('Leader Section', () => {
    ...
    it('should not show leader section when leader is null', () => {
      testRender(
        <WheelPlayers leader={null} currentSpinner={mockContestant2} currentTotal={0.5} />,
      );
    ...
    it('should not show leader section when leader is undefined', () => {
      testRender(<WheelPlayers currentSpinner={mockContestant2} currentTotal={0.5} />);
  ...
  describe('Current Spinner Section', () => {
    ...
    it('should show $0.00 when currentTotal is 0', () => {
      testRender(<WheelPlayers currentSpinner={mockContestant2} currentTotal={0} />);
    ...
    it('should not show current section when currentSpinner is null', () => {
      testRender(
        <WheelPlayers leader={mockContestant1} leaderTotal={0.75} currentSpinner={null} />,
      );
  ...
  describe('Waiting Spinners Section', () => {
    ...
    it('should show waiting section with multiple spinners', () => {
      testRender(<WheelPlayers waitingSpinners={[mockContestant3, mockContestant4]} />);
    ...
    it('should not show waiting section when waitingSpinners is empty array', () => {
      testRender(
        <WheelPlayers currentSpinner={mockContestant2} currentTotal={0.5} waitingSpinners={[]} />,
      );
    ...
    it('should render three waiting spinners', () => {
      testRender(
        <WheelPlayers waitingSpinners={[mockContestant1, mockContestant2, mockContestant3]} />,
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle many waiting spinners', () => {
      const manySpinners = [mockContestant1, mockContestant2, mockContestant3, mockContestant4];
