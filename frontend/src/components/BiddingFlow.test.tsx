...
describe('Bidding Flow Integration (Critical)', () => {
  ...
  describe('Current Bidder Progression', () => {
    it('should progress current bidder as bids are submitted (fresh row)', () => {
      ...
      expect(screen.getByTestId('podium-1')).toHaveAttribute('data-current', 'true');
      expect(screen.getByTestId('podium-2')).toHaveAttribute('data-current', 'false');
      ...
      expect(screen.getByTestId('podium-1')).toHaveAttribute('data-current', 'false');
      expect(screen.getByTestId('podium-2')).toHaveAttribute('data-current', 'true');
      expect(screen.getByTestId('bid-amount-1')).toHaveTextContent('4');
    });
  });
  ...
  describe('Winner Display Integration', () => {
    it('should display winner with enlarged photo and badge', () => {
      ...
      expect(screen.getByTestId('podium-1')).toHaveAttribute('data-winner', 'true');
  ...
  describe('Full Bidding Round Simulation', () => {
    it('should complete full bidding cycle from contestants to winner', () => {
      ...
      expect(screen.getByTestId('podium-2')).toHaveAttribute('data-winner', 'true');
