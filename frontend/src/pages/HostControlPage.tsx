...
import { Box, Button, Card, Container, Heading, Stack, Text, HStack, VStack } from '@chakra-ui/react';
            ...
            <Stack gap={4}>
              ...
              {!canStartGame && (
                <Text fontSize="sm" color="orange.600">
                  ⚠️ Cannot start game: Need at least 5 eligible audience members. Currently have {eligibleCount}.
                  Add more players with the "audience" role from the Admin Tools page.
                </Text>
              )}
